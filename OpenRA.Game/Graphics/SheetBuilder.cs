...
namespace OpenRA.Graphics
{
	...
	public sealed class SheetBuilder : IDisposable
	{
		...
		/// <summary>
		/// ƒќбавл€ет байты из ISpriteFrame класса в массив байтов текстуры
		/// </summary>
		...
		/// <summary>
		/// ƒобавл€ет байты в массив байтов текстуры, котора€ прив€зан к данному SheetBuilder.
		/// </summary>
		...
		/// <summary>
		/// –езервирует место под SPrite в текстуре opengl
		/// ќпредел€ет в какой канал текстуры будут записаны байты
		/// </summary>
