...
namespace OpenRA.Graphics
{
	public class RgbaColorRenderer
	{
		...
		public void DrawLine(float3 start, float3 end, float width, Color startColor, Color endColor)
		{
			...
			vertices[0] = new Vertex(start - corner + Offset, sr, sg, sb, sa, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[1] = new Vertex(start + corner + Offset, sr, sg, sb, sa, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[2] = new Vertex(end + corner + Offset, er, eg, eb, ea, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[3] = new Vertex(end + corner + Offset, er, eg, eb, ea, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[4] = new Vertex(end - corner + Offset, er, eg, eb, ea, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[5] = new Vertex(start - corner + Offset, sr, sg, sb, sa, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
		...
		public void DrawLine(float3 start, float3 end, float width, Color color)
		{
			...
			vertices[0] = new Vertex(start - corner + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[1] = new Vertex(start + corner + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[2] = new Vertex(end + corner + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[3] = new Vertex(end + corner + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[4] = new Vertex(end - corner + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[5] = new Vertex(start - corner + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			parent.DrawRGBAVertices(vertices);
		}
		...
		void DrawConnectedLine(float3[] points, float width, Color color, bool closed)
		{
			...
			for (var i = 0; i < limit; i++)
			{
				...
				// Fill segment
				vertices[0] = new Vertex(ca + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
				vertices[1] = new Vertex(cb + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
				vertices[2] = new Vertex(cc + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
				vertices[3] = new Vertex(cc + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
				vertices[4] = new Vertex(cd + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
				vertices[5] = new Vertex(ca + Offset, r, g, b, a, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
				parent.DrawRGBAVertices(vertices);
		...
		public void FillTriangle(float3 a, float3 b, float3 c, Color color)
		{
			...
			vertices[0] = new Vertex(a + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[1] = new Vertex(b + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[2] = new Vertex(c + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			parent.DrawRGBAVertices(vertices);
		}
		...
		public void FillRect(float3 a, float3 b, float3 c, float3 d, Color color)
		{
			...
			vertices[1] = new Vertex(b + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[2] = new Vertex(c + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[3] = new Vertex(c + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[4] = new Vertex(d + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			vertices[5] = new Vertex(a + Offset, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
			parent.DrawRGBAVertices(vertices);
		}
		...
		static Vertex VertexWithColor(float3 xyz, Color color)
		{
			...
			return new Vertex(xyz, cr, cg, cb, ca, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0);
		}
