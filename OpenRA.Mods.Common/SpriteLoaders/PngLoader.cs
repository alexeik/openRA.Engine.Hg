...
{
	public class PngLoader : SpriteLoaderBase
	{
		class PngFrame : ISpriteFrame
		{
		...
		public PngLoader(byte[] data, int width, int height, Color[] palette = null,
